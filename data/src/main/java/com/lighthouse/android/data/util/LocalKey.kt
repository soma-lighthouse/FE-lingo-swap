...
object LocalKey {
    const val USER_ID = "com.lighthouse.lingo-talk.UUID"
    const val USER_NAME = "com.lighthouse.lingo-talk.USER_NAME"
    const val ACCESS_TOKEN = "com.lighthouse.lingo-talk.access-token"
    const val REFRESH_TOKEN = "com.lighthouse.lingo-talk.refresh-token"
    const val ACCESS_TOKEN_EXPIRE = "com.lighthouse.lingo-talk.access-token-expire"
    const val REFRESH_TOKEN_EXPIRE = "com.lighthouse.lingo-talk.refresh-token-expire"
